...
| Shutter | Global/Rolling | The camera model I recommend for the first prototype is very confusing when it comes to disclosing the shutter type however, that shouldn't matter too much for a first prototype. |
