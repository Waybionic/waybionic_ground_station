...
_ARGUMENTS = [
    ...
    ('angular_velocity_stddev', '0.0',
     'Gyroscope noise stddev in rad/s. 0 means unknown (all-zero covariance).',
     float),
    ('linear_acceleration_stddev', '0.0',
     'Accelerometer noise stddev in m/s^2. 0 means unknown (all-zero covariance).',
     float),
    ('orientation_stddev', '0.05',
     'Demo-topic-only orientation stddev in rad. Not applied to the raw topic.',
     float),
