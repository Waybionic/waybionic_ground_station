...
def generate_launch_description():
    ...
    # Defaults to the assumption-free model: the 2026-09-05 export as supplied,
    # every part fixed at its given transform, zero DOF. The articulated
    # full_arm_smaller.urdf contains inferred chain order, pivots and axes, and
    # is what MoveIt loads; pass model:= to view either of the others.
    default_model_path = os.path.join(
        waybionic_desc_dir, 'urdf', 'full_arm_smaller_as_exported.urdf'
    )
